...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYmFyYW5rdXRheSIsImEiOiJjazkycXZ6aWQwMjVzM2Vtd3JyZTBjbTd6In0.RLg9s2AjKjYcBo2SRUCEZw';
    ...
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            res = _context2.sent;
            // TODO: I think the above condition is correct! Check it...
...
var stripe = Stripe('pk_test_L0CiYNmKeffdKgR2mKhGzO5y00Cni0fups');
...
if (userDataForm) userDataForm.addEventListener('submit', function (e) {
  e.preventDefault(); // in order to upload file we have to add multipart/form-data programmatically
  ...
  form.append('photo', document.getElementById('photo').files[0]); // updateUserData(name, email);
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 7:
            document.querySelector('.btn--save-password').textContent = 'Save settings'; // Clear the password fields...
...
if (bookBtn) bookBtn.addEventListener('click', function (e) {
  e.target.textContent = 'Processing...'; // with e.target; click the button on line 85 of tour.pug to tourId, the tour-id is coverted automatically to the Camel-Case notation as tourId.
